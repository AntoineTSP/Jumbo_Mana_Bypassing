...
from functions import Params,DeepQLearning,EpsilonGreedy, run_env
from functions import postprocess , plot_q_values_map, plot_states_actions_distribution
from functions import create_custom_frozenlake
from functions import tuple_to_grid_index,CustomEnv
...
for map_size in map_sizes:
    ...
    env = CustomEnv(env, custom_rewards, vertices, map_size, obstacle_vertices, be_sneaky, custom_goal
                    , custom_holes, state = custom_start)
